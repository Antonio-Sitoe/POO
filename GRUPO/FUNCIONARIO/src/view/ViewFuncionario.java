...
public class ViewFuncionario implements ActionListener, MouseListener {
	...
	private JTextField txtCodigo, txtNome, txtContacto, txtDepartamento, txtGenero, txtEstadoCivil, txtDiasTrabalhados,
			txtSalarioDiario;
	...
	private void initialize() {
		...
		txtDepartamento.setBounds(120, 130, 250, 30);
		panel.add(txtDepartamento);

		txtGenero = new JTextField();
		txtGenero.setBounds(120, 165, 250, 30);
		panel.add(txtGenero);

		txtEstadoCivil = new JTextField();
		txtEstadoCivil.setBounds(120, 200, 250, 30);
		...
		panelTabela.setBorder(
				new TitledBorder(null, "Listagem de Funcionários", TitledBorder.LEADING, TitledBorder.TOP, null, null));
	...
	public void mouseClicked(MouseEvent e) {
		if (tabela.getSelectedRow() != -1) {
			...
			txtDepartamento.setText(tabela.getValueAt(row, 3).toString());
			txtGenero.setText(tabela.getValueAt(row, 4).toString());
			txtEstadoCivil.setText(tabela.getValueAt(row, 5).toString());
